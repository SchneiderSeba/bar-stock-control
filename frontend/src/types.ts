...
export type DashboardData={stockValue:number;potentialRevenue:number;potentialProfit:number;purchases:number;productCount:number;lowStockCount:number;monthlyComparison:{previous:MonthMetrics;current:MonthMetrics}}
