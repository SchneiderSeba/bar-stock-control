...
export type Product={id:number;sku:string;imageVersion?:string;name:string;category:string;unit:string;stock:number;minimumStock:number;costPrice:number;sellingPrice:number;supplier?:Supplier;active:boolean}
